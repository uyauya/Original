...
이 에셋은 유니티 테크놀로지 재펜에서 제공하는 "SD unity-chan" 와 "SD Kohaku-Chanz"를 최적화를 위한 가공과 활용성을 높이는 가공을 거친 그래픽 에셋입니다. 

이 문서 상단에 매쉬 네임과 텍스쳐 네임을 정리한 스프레드시트가 있습니다. 

모델 매쉬는 캐릭터와 의상이 묶여있는 모델과 파츠화된 모델 두가지 타입이 있습니다. 
각각 model/Model-part 폴더와 model/model-set에 있습니다. 
제공된 prefab에도 두가지 타입이 있으며 set모델로 만들어진 것은 'Set_'로 시작하는 이름을 가졌습니다. 
