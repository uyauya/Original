...
public class ShakeCamera : MonoBehaviour
{
	...
	public float shake_decay = 1.0f;			// 揺れの減衰率
	...
	{  
		if (shake_intensity > 0) {  
			...
			transform.rotation = new Quaternion (
				originRotation.x + Random.Range (-shake_intensity, shake_intensity) * 1.05f,  
				originRotation.y + Random.Range (-shake_intensity, shake_intensity) * 1.05f,  
