...
public class PlayerLevel : MonoBehaviour 
{
	...
	public static List <UserParam> userParamList = new List<UserParam>() 
	{
        ...
        new UserParam(3,01,390,9000,9000,2000, string.Empty,0),		//Level01
        ...
        new UserParam(3,02,408,9900,9450,3000, string.Empty,0),		//Level02
        ...
        new UserParam(3,03,450,10500,10380,4400, string.Empty,0),	//Level03
        ...
        new UserParam(3,04,471,11400,10890,6600, string.Empty,0),	//Level04
        ...
        new UserParam(3,05,516,12000,12000,10000, string.Empty,0),	//Level05
        ...
        new UserParam(3,06,540,12600,12600,15000, string.Empty,0),	//Level06
        ...
        new UserParam(3,07,594,13800,13860,22500, string.Empty,0),	//Level07
        ...
        new UserParam(3,08,624,14400,14650,33800, string.Empty,0),	//Level08
		...
		new UserParam(3,09,684,15900,16020,52000, string.Empty,0),	//Level09
